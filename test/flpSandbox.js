					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project Brazilian table ",
									"targetURL": "#prjbr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"prjbr-display": {
								"semanticObject": "prjbr",
								"action": "display",
								"description": "semana d oprogramador sap fiori do zero",
								"title": "Project Brazilian table ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prjbr",
									"url": sap.ui.require.toUrl("prjbr")
								}
							}
						}
					}
